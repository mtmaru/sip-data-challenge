...
閲覧ログのない学生 (テストだけ受けた学生) の予測結果を50 (全学生の総合成績の平均点) に置き換えた。閲覧ログのない学生が学習データに含まれていないことから、もし閲覧ログのない学生がテストデータに含まれていた場合外挿となり、予測精度が大幅に悪化する可能性があるため (手元のRMSEが10を下回っていたにもかかわらず、リーダーボード上位陣のRMSEが16台であったことから、学習データにないパターンがテストデータに含まれていると予想)。
